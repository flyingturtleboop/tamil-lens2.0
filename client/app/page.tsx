          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/auth/signin?next=/scan"
                  className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-7 py-3 rounded-xl font-semibold text-lg hover:shadow-xl hover:scale-105 transition-all"
                >
                  Open App
                </Link>
                <Link
                  href="/auth/signin?next=/practice"
                  className="bg-white text-slate-700 px-7 py-3 rounded-xl font-semibold text-lg border-2 border-slate-200 hover:border-cyan-500 hover:shadow-lg transition-all"
                >
                  Try Practice Quiz
                </Link>
              </div>
